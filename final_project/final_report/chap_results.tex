\section{Results}\label{sec:results}
	...
	\subsection{Yeast Monoculture}
		...
		At time $t\approx 25$ the GEM is blocked and the population starts to die out.
		\begin{figure}[h]
			\centering
		...
		\begin{figure}[h]
			...
			\caption{Glucose and ethanol concentrations measured in a real-life scenario with varying lactate concentrations \cite{narendranath_effects_1997}. }
