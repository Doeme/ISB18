...
\begin{table*}[h]
\centering
\caption{Example for a centered very wide table}
\label{tab:example_center_wide_table}
\begin{tabular}{llllll}
\rowcolor[HTML]{EFEFEF} 
...
$v_{max,M,glc}$          &  18.5 &  18.5 & \si{\milli\mole\per\gram_{DW}\per\hour} & ? \\
$v_{max,M,o}$            &   2.5 &   2.5 & \si{\milli\mole\per\gram_{DW}\per\hour} & ? \\
$k_{M,glc}$ (g/l)        &   0.5 &   0.5 & \si{\milli\mole\per\liter} & ?  \\
$k_{M,o}$                & 0.005 & 0.005 & \si{\milli\mole\per\liter} & ?  \\
Mortability (?)          &     ? &     ? & ?  & ? \\
$I_{M,glc,eth}$ (g/l)    & 10\cite{hjersted_genome-scale_2007} & - & \si{\milli\mole\per\liter} & ? \\
$I_{M,glc,lac}$          & TBD & -  & \si{\milli\mole\per\liter} & ? \\
\end{tabular}
\end{table}
...
$x_{yeast}$ & ? & \si{\gram_{DW}\per\liter} & - \\
$x_{lac}$ & ? & \si{\gram_{DW}\per\liter} & - \\
\end{tabular}
\end{table}}
