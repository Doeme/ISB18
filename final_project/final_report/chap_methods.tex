...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\linewidth]{figures/GEM.pdf}
\caption{bla}
\label{fig:GEM}
\end{figure}
...
%       Rose & Teal & Plum & Sand & \rotatebox{90}{Peach} & \\
%     \end{block}
...
Maximum glucose uptake rate (\si{\milli\mole\per\gram\per\hour})     & 18.5 & 18.5 \\
Maximum oxygen uptake rate (\si{\milli\mole\per\gram\per\hour})      & 2.5 & 2.5 \\
Glucose uptake saturation constant (\si{\gram\per\liter})   & 0.5 & 0.5 \\
Oxygen uptake saturation constant (\si{\milli\mole\per\liter})     & 0.005 & 0.005 \\
Glucose uptake inhibition by ethanol constant (\si{\gram\per\liter})     & 10\cite{hjersted_genome-scale_2007} & - \\
Glucose uptake inhibition by lactic acid constant (\si{\milli\mole\per\liter})     & 30 & - \\
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Initial values of the simulation}
