...
akg_c=m.metabolites.get_by_id('akg[c]');
oaa_c=m.metabolites.get_by_id('oaa[c]');
co2_c=m.metabolites.get_by_id('co2[c]');
nadph_c=m.metabolites.get_by_id('nadph[c]');
nadp_c=m.metabolites.get_by_id('nadp[c]');
...
oxex=m.reactions.get_by_id('EX_o2(e)');
...
glcex=m.reactions.get_by_id('EX_glc(e)');
